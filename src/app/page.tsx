    ...
    <div className="container mx-auto p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <form action={createBoard} className="h-32">
          <div className="h-full rounded-xl bg-surface-container-low p-4 flex flex-col justify-center items-center group transition-colors hover:bg-surface-container">
            <input
              type="text"
              name="title"
